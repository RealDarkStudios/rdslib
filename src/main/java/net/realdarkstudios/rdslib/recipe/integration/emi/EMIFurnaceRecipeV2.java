...
public class EMIFurnaceRecipeV2 implements EmiRecipe {
    ...
    private final AbstractFurnaceLikeRecipeV2 recipe;
    private final int fuelMultiplier;
    private final boolean infiniBurn;

    public EMIFurnaceRecipeV2(AbstractFurnaceLikeRecipeV2 recipe, EmiRecipeCategory category, int fuelMultiplier, boolean infiniBurn) {
