...
public abstract class FurnaceLikeDisplay extends BasicDisplay implements SimpleGridMenuDisplay {
    ...
    public FurnaceLikeDisplay(AbstractFurnaceLikeRecipeV2 recipe) {
        this(EntryIngredients.ofIngredients(recipe.getIngredients()), Collections.singletonList(EntryIngredient.of(EntryStack.of(VanillaEntryTypes.ITEM, recipe.getResultItem()))),
