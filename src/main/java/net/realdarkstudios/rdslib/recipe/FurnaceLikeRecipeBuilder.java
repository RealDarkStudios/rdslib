...
public class FurnaceLikeRecipeBuilder implements RecipeBuilder {
    ...
    private FurnaceLikeRecipeBuilder(RecipeCategory pCategory, ItemLike pResult, Ingredient pIngredient, float pExperience, int pCookingTime, RecipeSerializer<? extends Recipe> pSerializer) {
     ...
     */
    public static FurnaceLikeRecipeBuilder customSmelting(Ingredient pIngredient, RecipeCategory pCategory, ItemLike pResult, float pExperience, int pCookingTime, RecipeSerializer<? extends Recipe> pSerializer) {
        return new FurnaceLikeRecipeBuilder(pCategory, pResult, pIngredient, pExperience, pCookingTime, pSerializer);
    }
    ...
    public void save(Consumer<FinishedRecipe> pFinishedRecipeConsumer, ResourceLocation pRecipeId) {
        ...
        pFinishedRecipeConsumer.accept(new Result(pRecipeId, this.group == null ? "" : this.group, this.ingredient, this.result, this.experience, this.cookingTime, this.advancement, pRecipeId.withPrefix("recipes/" + this.category.getFolderName() + "/"), this.serializer));
    }
