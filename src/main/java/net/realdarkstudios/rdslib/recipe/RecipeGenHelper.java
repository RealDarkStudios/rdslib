...
public class RecipeGenHelper {
    ...
    public void customSmelting(Consumer<FinishedRecipe> pFinishedRecipeConsumer, ItemLike pIn, ItemLike pOut, float pExperience, int pDuration, RecipeSerializer<? extends Recipe> pSerializer, String pFurnaceString) {
        FurnaceLikeRecipeBuilder.customSmelting(Ingredient.of(pIn), RecipeCategory.MISC, pOut, pExperience, pDuration, pSerializer)
                .group(getItemName(pOut))
                .unlockedBy(getHasName(pIn), inventoryTrigger(ItemPredicate.Builder.item().of(pIn).build()))
                .save(pFinishedRecipeConsumer, new ResourceLocation(modid, getItemName(pOut) + pFurnaceString + getItemName(pIn)));
    }
    ...
    public void addCustomFurnaceRecipes(Consumer<FinishedRecipe> pFinishedRecipeConsumer, FurnaceLikeSerializer<? extends Recipe> pSerializer, String pFurnaceString) {
        ...
        FurnaceLikeRecipeBuilder.customSmelting(Ingredient.of(Blocks.SEA_PICKLE), RecipeCategory.MISC, Items.LIME_DYE, 0.1F, pCookingTime, pSerializer).unlockedBy("has_sea_pickle", has(Blocks.SEA_PICKLE)).save(pFinishedRecipeConsumer, new ResourceLocation(modid, getItemName(Items.LIME_DYE) + pFurnaceString + getItemName(Blocks.SEA_PICKLE)));
