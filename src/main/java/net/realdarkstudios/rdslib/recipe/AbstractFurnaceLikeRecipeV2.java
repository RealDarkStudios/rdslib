...
public abstract class AbstractFurnaceLikeRecipeV2 extends AbstractCookingRecipe {
    public AbstractFurnaceLikeRecipeV2(RecipeType<?> pType, ResourceLocation pId, String pGroup, CookingBookCategory pCategory, Ingredient pIngredient, ItemStack pResult, float pExperience, int pCookingTime) {
