...
public class Rarities {
    ...
    public static class Builder {
        ...
        public Rarities.Builder name(String pName) {
            this.name = pName;
            return this;
        }

        public Rarities.Builder color(TextColor pColor) {
            this.color = pColor;
            return this;
        }

        public Rarities.Builder bold() {
            this.bold = true;
            return this;
        }

        public Rarities.Builder italic() {
            this.italic = true;
            return this;
        }

        public Rarities.Builder underline() {
            this.underline = true;
            return this;
        }

        public Rarities.Builder strikethrough() {
            this.strikethrough = true;
            return this;
        }

        public Rarities.Builder obfuscate() {
            this.obfuscate = true;
            return this;
        }

        public Rarities.Builder clickEvent(ClickEvent pClickEvent) {
            this.clickEvent = pClickEvent;
            return this;
        }

        public Rarities.Builder hoverEvent(HoverEvent pHoverEvent) {
            this.hoverEvent = pHoverEvent;
            return this;
        }

        public Rarities.Builder font(ResourceLocation pFont) {
            this.font = pFont;
            return this;
        }
